...
@section('content')
    @php
        $no = 0;
    @endphp
    <div class="main" style="background-color: rgb(126, 85, 85);">
        <style>
            td {
                color: #000000;
            }
        ...
        <div class="main-content"
            style=" height: 1000%; width: 200; background-color: rgb(126, 85, 85); background-size: cover; background-position: center; ">
            <div class="panel-heading" style="">
                <h1 class="panel-title" style="color: #b8b8b8; font-size: 4ch; padding-bottom: 4%; padding-top: 0px">
                    {{ $users }}</h1>
            </div>
            <div class="container-fluid" style="color: rgb(126, 85, 85); ">
                <div class="row">
                    <div class="col-md-12">
                        <!-- TABLE HOVER -->
                            ...
                            <div style="display: flex; justify-content: space-between; padding-top: 20px">
                                ...
                                <div style="width: 100%; padding-top: 20px; padding-left: 120px">
                                    <button type="button" class="btn btn-"
                                        style="background-color: rgb(126, 85, 85); color: white" data-toggle="modal"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/pasien/{{ $pasien->id }}/edit" class="btn btn- btn-sm"
                                                        style="background-color:  rgb(126, 85, 85); color: white">Edit
                                                    </a>
                                                    <a href="/pasien/{{ $pasien->id }}/delete" class="btn btn- btn-sm"
                                                        style="background-color: rgb(126, 85, 85); color: white"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary"
                                                    style="background-color: rgb(126, 85, 85); ">Simpan</button>
                                            </div>
                                            </form>
                                        </div>
